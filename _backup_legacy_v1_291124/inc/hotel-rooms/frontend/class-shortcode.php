            ...
            <div class="vie-modal-container vie-modal-md">
                ...
                <form id="vie-booking-form">
                    ...
                    <div class="vie-booking-step-content" data-step="1">
                        ...
                        <!-- Bed Type Selection -->
                        <div class="vie-form-group vie-bed-type">
                            <label><?php _e('Loại giường mong muốn', 'flavor'); ?></label>
                            <select name="bed_type" id="booking-bed-type">
                                <option value="double" selected><?php _e('1 Giường đôi lớn (Double Bed)', 'flavor'); ?></option>
                                <option value="twin"><?php _e('2 Giường đơn (Twin Beds)', 'flavor'); ?></option>
                            </select>
                        </div>
                    ...
                    <div class="vie-booking-step-content" data-step="2" style="display:none">
                        ...
                        <!-- Invoice Request -->
                        <div class="vie-form-group vie-invoice-section">
                            <label class="vie-checkbox">
                                <input type="checkbox" name="invoice_request" id="booking-invoice-request" value="1">
                                <span class="vie-checkbox-label"><?php _e('Tôi muốn xuất hóa đơn đỏ (VAT)', 'flavor'); ?></span>
                            </label>

                            <div class="vie-invoice-info" id="booking-invoice-info" style="display:none">
                                <div class="vie-form-group">
                                    <label><?php _e('Tên công ty', 'flavor'); ?> <span class="required">*</span></label>
                                    <input type="text" name="invoice_company_name" id="booking-invoice-company">
                                </div>
                                <div class="vie-form-row">
                                    <div class="vie-form-group vie-form-half">
                                        <label><?php _e('Mã số thuế', 'flavor'); ?> <span class="required">*</span></label>
                                        <input type="text" name="invoice_tax_id" id="booking-invoice-tax">
                                    </div>
                                    <div class="vie-form-group vie-form-half">
                                        <label><?php _e('Email nhận hóa đơn', 'flavor'); ?></label>
                                        <input type="email" name="invoice_email" id="booking-invoice-email">
                                    </div>
                                </div>
                            </div>
                        </div>

                        <!-- Transport Section - Only shown for Combo -->
                        <div class="vie-transport-section" id="vie-transport-section" style="display:none">
                            <div class="vie-transport-header">
                                <span class="vie-transport-title">
                                    <span class="dashicons dashicons-car"></span>
                                    <strong><?php _e('Xe đưa đón (Bắt buộc với gói Combo)', 'flavor'); ?></strong>
                                </span>
                            </div>

                            <div class="vie-transport-options" id="vie-transport-options">
                                <div class="vie-form-row">
                                    <div class="vie-form-group vie-form-half">
                                        <label><?php _e('Chọn giờ đi (Sài Gòn → Resort)', 'flavor'); ?> <span
                                    ...
                                    <div class="vie-form-group vie-form-half">
                                        <label><?php _e('Chọn giờ về (Resort → Sài Gòn)', 'flavor'); ?> <span
                                                class="required">*</span></label>
                                ...
                                <div class="vie-transport-error" id="vie-transport-error" style="display:none">
                                    ...
                                    <?php _e('Vui lòng chọn giờ xe đưa đón cho gói Combo', 'flavor'); ?>
                                </div>
                            </div>
                        </div>
