...
<section class="vie-sepay-payment">
    ...
    <div class="sepay-body">
        ...
        <div class="sepay-booking-summary">
            ...
            <div class="summary-row">
                <span>Số khách:</span>
                <span><?php echo esc_html($booking->num_adults); ?> người
                    lớn<?php echo $booking->num_children > 0 ? ', ' . $booking->num_children . ' trẻ em' : ''; ?></span>
            </div>
        ...
        <div class="sepay-pay-info">
            ...
            <div class="sepay-qr-section">
                ...
                <div class="sepay-qr-wrapper">
                    <img src="<?php echo esc_url($qr_code_url); ?>" alt="QR Code thanh toán" class="sepay-qr-image"
                        loading="eager">
                </div>
                <div class="sepay-download-qr">
                    <a href="<?php echo esc_url($qr_code_url . '&download=yes'); ?>"
                        download="qr-payment-<?php echo esc_attr($booking->booking_code); ?>.png">
                ...
                <div class="sepay-bank-card">
                    ...
                    <div class="sepay-bank-header">
                        <img src="<?php echo esc_url($bank_logo_url); ?>"
                            alt="<?php echo esc_attr($bank_info['short_name']); ?>" class="sepay-bank-logo">
                    </div>
